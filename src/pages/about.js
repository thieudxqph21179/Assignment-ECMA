        ...
        <div class="container-fluid">
            <div id="about" class="row about-section">
                <div class="col-lg-4 about-card">
                    ...
                    <button class="btn btn-outline-danger"><i class="icon-down-circled2 "></i>Hồ sơ của tôi</button>
                </div>
                <div class="col-lg-4 about-card">
                    <h3 class="font-weight-light">${profile.info.title}</h3>
                    <span class="line mb-5"></span>
                    <ul class="mt40 info list-unstyled">
                        <li><span>Birthdate</span> : ${profile.info.date}</li>
                        <li><span>Email</span> : ${profile.info.email}</li>
                        <li><span>Phone</span> : ${profile.info.phone}</li>
                        <li><span>Address</span> :  ${profile.info.address}</li>
                    </ul>
